        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 my-4 text-center text-lg-start">
                    <img src="assets/images/logo.svg" alt="LogoModaMulher">
                </div>

                <div class="col-lg-7 my-4 d-flex align-itens-center">

                    <form action="" class="site-search w-100">

                        <div class="input-group text-primary">

                            <input type="text" class="form-control rounded-pill py-2 px-4" placeholder="Choose your style here">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="#"></a>Lançamentos</li>
                            <li><a class="dropdown-item" href="#"></a>Moda Casual</li>
                            <li><a class="dropdown-item" href="#"></a>Moda Praia</li>
